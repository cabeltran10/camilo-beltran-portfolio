...
export const CONTACT_SECTION_CONTENT = {
  ...
  description:
    "If you're hiring for roles in SaaS, cybersecurity, or LATAM sales leadership—I'd love to connect and explore how I can contribute to your team.",
  ...
  finalBox: {
    ...
    description:
      'I believe in building relationships through meaningful conversations. Let’s talk and see how we can collaborate.',
...
export const FOOTER_SECTION_CONTENT = {
  ...
  subtitle:
    'Connecting solutions to outcomes across SaaS, cybersecurity, and LATAM markets.',
