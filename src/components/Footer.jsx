...
import { Heart, ArrowUp } from 'lucide-react'; // Eliminado Code2
import { useTheme } from '../context/ThemeContext';

// --- CAMBIO 1: Importa tu logo aquí ---
import SIGNATURE from '../assets/images/signature.png'; // Asegúrate de que esta ruta sea correcta
          ...
          <motion.div
            ...
            <motion.div
              ...
              <motion.div
                ...
                <span>{FOOTER_SECTION_CONTENT.title}</span>
              </motion.div>
              ...
              <motion.p
                ...
                {FOOTER_SECTION_CONTENT.subtitle}
              </motion.p>
            </motion.div>
            <motion.p
              variants={itemVariants}
              ...
              {FOOTER_SECTION_CONTENT.description}
            </motion.p>
            <motion.div
              variants={itemVariants}
            ...
            <motion.div
              ...
              <p
                ...
                © {new Date().getFullYear()} {FOOTER_SECTION_CONTENT.copyRight}
              </p>
              <p
                className={`text-xs ${
                  isDarkMode ? 'text-gray-600' : 'text-gray-500'
                }`}>
                {FOOTER_SECTION_CONTENT.info}
              </p>
            </motion.div>
            ...
            <motion.div variants={itemVariants}>
              ...
              <motion.a
                ...
                <ArrowUp size={16} />
                <span>{FOOTER_SECTION_CONTENT.backToTop}</span>
              </motion.a>
            </motion.div>
          </motion.div>
        </div>
